...
$user_cred = $db->select($_SESSION['id']);
...
<head>
    <meta charset="utf-8">
    <title>Driver Hiring Adminpanel</title>
                ...
                <form action="./controllers/edituser.php" method="POST">
                    <div class="container-fluid pt-4 px-4 text-white">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <p class="text-primary">Note: You can only change few information in this page, If you are admin please check the "User Config" page for more changes.</p>
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingInput" value="<?= $user_cred[0]['date_created'];?>" readonly>
                                <label for="floatingInput" class="text-primary">Date of Created</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingInput" value="<?= $user_cred[0]['role'];?>" readonly>
                ...
                <div class="bg-secondary rounded-top p-4">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            &copy; <a href="#">Baktelecom</a>, All Right Reserved. 
                        </div>
                        <div class="col-12 col-sm-6 text-center text-sm-end">
                            <!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->
                            Designed and developed By Sabir</a>
                        </div>
                    </div>
                </div>
            </div>
