...
#chatbox {
    ...
    <script>
        ...
        function getMessages(senderId, receiverId) {
            $.get("getMessages.php", {
                ...
                for (var i = 0; i < messages.length; i++) {
                    ...
                    var sender = message.sender_id == senderId ? "You" : "Driver";
        ...
        function handleSubmit(event) {
            ...
            var senderId = "<?=$_SESSION['token']?>"; // Replace with the actual sender ID
            var receiverId = <?=$_SESSION['driverid']?> // Replace with the actual receiver ID
